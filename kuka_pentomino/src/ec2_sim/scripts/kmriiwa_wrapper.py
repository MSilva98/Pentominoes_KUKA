...
class KmrIiwaWrapper:
    def __init__(self, kmriiwa_simulated):
        ...
        kmriiwa_services = [
            ...
            ('/move_relative_impedance_tcp', euroc_ros_srvs.MoveRelativeImpedanceTCP, self.on_move_relative_impedance_tcp),
            ...
            ('/pause_execution', std_srvs.Empty, lambda x:None),
            ('/resume_execution', std_srvs.Empty, lambda x:None),
            ('/cancel_all_executions', std_srvs.Empty, lambda x:None)
        ]
    ...
    def on_move_relative_tcp(self, req):
        print "kmriiwa_wrapper: on_move_relative_tcp:"
    ...
    def on_move_relative_impedance_tcp(self, req):
        # stiffness is ignored
        self.kmriiwa_simulated.move_relative_tcp(req.transformation, req.parameter.velocity, req.parameter.blocking)
        return euroc_ros_srvs.MoveRelativeImpedanceTCPResponse("")
    ...
    def publish(self):
        ...
        self.tb.sendTransform((self.kmriiwa_simulated.MAP_OFFSET_X, self.kmriiwa_simulated.MAP_OFFSET_Y, 0),
                            tf.transformations.quaternion_from_euler(0, 0, 0),
                            rospy.Time.now(),
                            "world", "map_base")

        #self.tb.sendTransform((0, 0, 0.16), 
        self.tb.sendTransform((0, 0, 0.205), 
